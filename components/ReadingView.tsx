...
const ReadingView: React.FC = () => {
  return (
    <div className="max-w-4xl mx-auto space-y-16 animate-in fade-in slide-in-from-bottom-6 duration-800 w-full">
      
      {/* Header */}
      <header className="space-y-6 md:space-y-8 border-b border-white/5 pb-12 md:pb-16 text-center md:text-left">
        <div className="inline-flex items-center gap-3 px-4 py-1.5 rounded-full border border-blue-500/20 bg-blue-500/5 text-blue-400 text-[9px] md:text-[10px] font-black uppercase tracking-[0.2em]">
          Internal Tool <span className="w-1 h-1 bg-blue-400 rounded-full animate-pulse"></span> Wise Business Plans
        </div>
        <h1 className="text-3xl sm:text-4xl md:text-6xl font-outfit font-extrabold tracking-tight text-white leading-tight">
        ...
        <div className="flex flex-wrap gap-4 md:gap-8 items-center justify-center md:justify-start text-xs text-gray-500 font-mono uppercase tracking-[0.2em]">
      ...
      <article className="prose prose-invert prose-lg max-w-none space-y-16">
          ...
          <div className="space-y-6 text-gray-300 font-light leading-relaxed text-base md:text-lg">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="glass p-6 rounded-2xl">
                    ...
                    <p className="text-xs md:text-sm text-gray-500">Finding a business that just applied for an SBA loan requires scraping noisy registries like Google Maps and State Filings.</p>
                </div>
                <div className="glass p-6 rounded-2xl">
                    <h5 className="text-white font-bold mb-2">Manual Fatigue</h5>
                    <p className="text-xs md:text-sm text-gray-500">Agents spent hours copying data into spreadsheets and sending emails one by one.</p>
                </div>
                <div className="glass p-6 rounded-2xl">
                    <h5 className="text-white font-bold mb-2">Spam Risks</h5>
                    <p className="text-xs md:text-sm text-gray-500">Sending bulk emails instantaneously triggers spam filters. A staggered approach was mandatory.</p>
                </div>
            </div>
          </div>
        </section>
        ...
        <section className="space-y-8">
          ...
          <div className="space-y-6 text-gray-300 font-light leading-relaxed text-base md:text-lg">
            ...
            {/* LIVE FLOW DIAGRAM */}
            <div className="mt-12 p-6 md:p-12 rounded-[2rem] md:rounded-[2.5rem] bg-black/20 border border-white/5 relative overflow-hidden">
                ...
                <div className="relative">
                    {/* Vertical Line Connector - perfectly aligned for mobile (left-4) and desktop (center) */}
                    <div className="absolute left-4 md:left-1/2 top-0 bottom-0 w-0.5 bg-gradient-to-b from-cyan-500/20 via-purple-500/20 to-green-500/20 md:-translate-x-1/2"></div>

                    {/* --- PHASE 1 HEADER --- */}
                    <div className="relative z-10 flex items-center justify-center gap-2 md:gap-4 mb-12">
                       <div className="h-px bg-cyan-500/30 w-8 md:w-24"></div>
                       <span className="text-cyan-400 font-mono text-[9px] md:text-xs uppercase tracking-[0.2em] font-bold bg-[#050505] px-2 border border-cyan-500/30 rounded-full py-1 whitespace-nowrap">Phase 1: Lead Gen</span>
                       <div className="h-px bg-cyan-500/30 w-8 md:w-24"></div>
                    </div>
                    ...
                    {/* --- PHASE 2 HEADER --- */}
                    <div className="relative z-10 flex items-center justify-center gap-2 md:gap-4 mb-12">
                       <div className="h-px bg-purple-500/30 w-8 md:w-24"></div>
                       <span className="text-purple-400 font-mono text-[9px] md:text-xs uppercase tracking-[0.2em] font-bold bg-[#050505] px-2 border border-purple-500/30 rounded-full py-1 whitespace-nowrap">Phase 2: Outreach</span>
                       <div className="h-px bg-purple-500/30 w-8 md:w-24"></div>
                    </div>
        ...
        <section className="bg-gradient-to-br from-blue-900/10 to-transparent border border-white/5 p-8 md:p-12 rounded-[2rem] md:rounded-[2.5rem] relative overflow-hidden">
          <h3 className="text-white font-bold mb-6 text-xl md:text-2xl tracking-tight">Business Impact</h3>
          ...
          <p className="mt-8 text-[9px] md:text-[10px] font-black text-blue-400 uppercase tracking-[0.3em]">— Wise Business Plans Engineering</p>
        </section>
